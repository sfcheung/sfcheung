...
I am Shu Fai. I like helping people, including myself, to do analysis in psychological studies. These are the R packages and other tools I am working on:
...
<img src="figures/modelbpp_logo.png" align="bottom" height="75" />[`modelbpp`](https://sfcheung.github.io/modelbpp/): How plausible is a structural equation model (SEM) given the data? H. Wu, S. O. Leung, and I presented a method using BIC posterior probability (BPP) to assess the plausibility of a set of models. This package, described in [Pesigan, Cheung, Wu, Chang, and Leung (2026)](https://doi.org/10.3758/s13428-025-02921-x), implements this approach by automatically identifying a set of *neighbouring models*, fitting them, and computing the BPPs. This allows researchers to see how plausible their models are, compared to models slightly different from the fitted models. In addition to the set of automatically generated models, researchers can also use the package to compare any set of models that are relevant to their contexts. ([A quick introduction](https://sfcheung.github.io/modelbpp/articles/modelbpp.html))
...
<img src="figures/manymome_logo.png" align="bottom" height="75" />[`manymome`](https://sfcheung.github.io/manymome/): Again? Yes, because it can also be used for regression models 😄! Moderation (`mo`), mediation (`me`), and moderated mediation (`mome`) in "`many`" regression models, fitted by several one-outcome regression models using `lm()`. In collaboration with S.-H. Cheung ([Cheung & Cheung, 2024](https://doi.org/10.3758/s13428-023-02224-z)). Our goal: Do things fast, and do them right. This package is for computing indirect effects and conditional indirect effects fast and easily, with as little coding as possible. Illustrations can be found in [this page for mediation](https://sfcheung.github.io/manymome/articles/med_lm.html) and [this page for moderated mediation](https://sfcheung.github.io/manymome/articles/mome_lm.html).
